class AboutPostsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @about_post.save
        ...
        format.json { render :show, status: :created, location: @about_post }
      else
  ...
  def update
    respond_to do |format|
      if @about_post.update(about_post_params)
        ...
        format.json { render :show, status: :ok, location: @about_post }
      else
  ...
  def destroy
    @about_post.destroy
    respond_to do |format|
      format.html { redirect_to about_posts_url, notice: 'About post was successfully destroyed.' }
  ...
  private
    ...
    def about_post_params
      params.require(:about_post).permit(:about_post)
    end
end
